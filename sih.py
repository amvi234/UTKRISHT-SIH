import cv2
import time
cap = cv2.VideoCapture('C:\\Users\\amvi1\\OneDrive\\Desktop\\amit\\python\\OPENCV\\img_det\\traffic4.mp4')  #Path to footage
car_cascade = cv2.CascadeClassifier('C:\\Users\\amvi1\\OneDrive\\Desktop\\amit\\python\\OPENCV\\img_det\\cars.xml')  #Path to cars.xml


#Coordinates of polygon in frame::: [[x1,y1],[x2,y2],[x3,y3],[x4,y4]]
coord=[[700,300],[1200,300],[700,100],[1200,100]]
